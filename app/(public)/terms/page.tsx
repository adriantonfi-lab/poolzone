  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0D0D1A', color: 'white', fontFamily: 'system-ui, sans-serif', padding: '40px 20px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <a href="/" style={{ color: '#00C896', textDecoration: 'none', fontSize: '14px', display: 'block', marginBottom: '32px' }}>← Volver</a>
        ...
        {[
          {
            ...
            content: 'PoolZone es una plataforma de entretenimiento que permite a los usuarios participar en quinielas deportivas basadas en predicciones del FIFA World Cup 2026. PoolZone NO es un servicio de apuestas deportivas regulado. Es un juego de habilidad y predicción para entretenimiento entre amigos y familia.'
          },
          {
            title: '2. Inscripción y Pago',
          ...
          },
          {
            ...
            content: 'Los créditos otorgados al momento de la inscripción ($5 equivalente = 50 créditos) son exclusivos para uso dentro de PoolZone. Pueden usarse para consultas al Oráculo IA, modificaciones tardías de predicciones y batallas entre usuarios. Los créditos NO son dinero real y NO pueden ser retirados ni canjeados por efectivo bajo ninguna circunstancia.'
          },
          {
          ...
          {
            title: '5. Sistema de Puntos',
            content: 'Todos los participantes inician con 100 puntos base. Los puntos se otorgan por predicciones correctas según los niveles establecidos en las reglas del juego. PoolZone se reserva el derecho de corregir errores en el cálculo de puntos. El ranking final se determina al concluir todos los partidos del torneo.'
          },
          {
            title: '6. Re-enganche',
          ...
          {
            title: '7. Modificaciones de Predicciones',
            content: 'Las predicciones pueden modificarse antes del inicio de cada partido. Modificaciones realizadas con menos de 24 horas antes del partido tienen un cargo adicional ($2, $3 o $5 según el tiempo restante). Estos cargos se descuentan de los créditos del usuario.'
          },
          {
            title: '8. Conducta del Usuario',
            content: 'Queda prohibido el uso de bots, scripts o cualquier método automatizado para manipular predicciones. El lenguaje ofensivo, discriminatorio o violento en el chat será motivo de expulsión sin reembolso. PoolZone se reserva el derecho de descalificar usuarios que violen estas normas.'
          },
          {
          ...
          },
          {
            ...
            content: 'PoolZone no se responsabiliza por problemas técnicos fuera de nuestro control (caídas de internet, interrupciones del servidor, etc.). En caso de problemas técnicos que afecten predicciones, se evaluará caso por caso. La responsabilidad máxima de PoolZone está limitada al monto pagado por el usuario.'
          },
          {
